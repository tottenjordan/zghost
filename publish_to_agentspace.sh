...
export REASONING_ENGINE_ID="4697966894882226176"
...
export AGENT_DISPLAY_NAME="Marketing Idea and Analyst"
export AGENT_DESCRIPTION="You are an AI assistant answering Marketing related questions and generating Images and Videos"
export AGENT_ID="marketing_analyst"
...
# -H "Content-Type: application/json" \
# -H "x-goog-user-project: ${PROJECT_ID}" \
# https://us-discoveryengine.googleapis.com/v1alpha/projects/${PROJECT_NUMBER}/locations/us/collections/default_collection/engines/${AS_APP}