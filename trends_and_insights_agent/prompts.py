...
<Get_Research>
1. Call the `campaign_researcher_agent` sub-agent to conduct research on concepts from the `campaign_guide`. Once this is complete, transfer to the `root_agent`.
2. Call the `yt_researcher_agent` sub-agent to gather context and insights for the trending YouTube video(s). Once this is complete, transfer to the `root_agent`.
3. Call the `gs_researcher_agent` sub-agent to gather the context of trending Search terms and understand any cultural significance. Once this is complete, transfer to the `root_agent`.
