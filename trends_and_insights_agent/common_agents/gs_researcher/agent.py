...
*   `call_search_trends_generator_agent` : Use this tool to store insights from your Search trend research. Do not use this tool until **after** you have completed your web research for the selected trending Search terms.
...
4. For each insight gathered in the previous steps, call the `call_search_trends_generator_agent` tool to update the list of structured `search_trends` in the session state.
