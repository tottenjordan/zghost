...
Use this tool to store insights from your Search trend research. Do not use this tool until **after** you have completed your web research for the selected trending Search terms.
...
async def call_search_trends_generator_agent(
    ...
    Args:
        Question: The question to ask the agent, use the tool_context to extract the following schema:
            trend_title: str -> Come up with a unique title to represent the trend. Structure this title so it
                begins with the exact words from the 'trending topic` followed by a colon and a witty catch-phrase.
            ...
            key_product_insights: str -> Suggest how this trend could possibly intersect with the target product
