...
def main():
    print("=" * 70)
    print("ADK E2E Test: McDonald's / McRib Shamrock Combos / Gen Z")
    ...
    response, tools = send_message(
        ...
        (
            ...
            "Start by planning the 4-scene storyboard for McRib Shamrock Combos "
            "targeting Gen Z, connecting the selected trends to the product. "
