...
```python
CHIRP_VOICES = {
    "professional_male": Male narrator for corporate/tech
    "professional_female": Female narrator for lifestyle
    "energetic_male": Upbeat youth-oriented voice
    "warm_female": Friendly, approachable tone
    "british_male": Sophisticated UK accent
    "british_female": Premium brand voice
}
```
